...
#include "arduniobot_msgs/action/arduniobot_task.hpp"
...
public:
    ...
    : Node("task_server", options)
  {
    ...
    action_server_ = rclcpp_action::create_server<arduniobot_msgs::action::ArduniobotTask>(
        this, "task_server", 
...
private:
  rclcpp_action::Server<arduniobot_msgs::action::ArduniobotTask>::SharedPtr action_server_;

  rclcpp_action::GoalResponse goalCallback(
      const rclcpp_action::GoalUUID& uuid,
      std::shared_ptr<const arduniobot_msgs::action::ArduniobotTask::Goal> goal)
  {
  ...
  rclcpp_action::CancelResponse cancelCallback(
      const std::shared_ptr<rclcpp_action::ServerGoalHandle<arduniobot_msgs::action::ArduniobotTask>> goal_handle)
  {
    (void)goal_handle;
    RCLCPP_INFO(get_logger(), "Received request to cancel goal");

    // Assuming 'arm' and 'gripper' are MoveIt planning groups
  ...
  void execute(const std::shared_ptr<rclcpp_action::ServerGoalHandle<arduniobot_msgs::action::ArduniobotTask>> goal_handle)
  {
    RCLCPP_INFO(get_logger(), "Executing goal");
    auto result = std::make_shared<arduniobot_msgs::action::ArduniobotTask::Result>();
