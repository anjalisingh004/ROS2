...
static rosidl_typesupport_introspection_c__MessageMember my_robot_interfaces__action__MoveTurtle_Goal__rosidl_typesupport_introspection_c__MoveTurtle_Goal_message_member_array[3] = {
  {
    "linear_vel_x",  // name
...
static rosidl_typesupport_introspection_c__MessageMember my_robot_interfaces__action__MoveTurtle_Feedback__rosidl_typesupport_introspection_c__MoveTurtle_Feedback_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces__action__MoveTurtle_Feedback, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_interfaces, action, MoveTurtle_SendGoal)() {
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_my_robot_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_interfaces, action, MoveTurtle_GetResult)() {
