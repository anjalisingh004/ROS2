...
action_client = ActionClient(Node('alexa_interface'), ArduniobotTask, "task_server")
...
skill_adapter = SkillAdapter(
    ...
    skill_id="amzn1.ask.skill.c0885338-9991-42f3-83e4-105988af49af",
    app=app)
