...
def generate_launch_description():
    ...
    moveit_config = (
        ...
        .robot_description_semantic(file_path=os.path.join(get_package_share_directory("arduinobot_moveit"), "config", "arduinobot.srdf"))
        .trajectory_execution(file_path=os.path.join(get_package_share_directory("arduinobot_moveit"), "config", "moveit_controllers.yaml"))
        .to_moveit_configs()
    )
